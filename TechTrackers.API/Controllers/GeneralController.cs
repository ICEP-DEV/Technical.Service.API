...

{
    ...
    public class GeneralController : Controller
    {
        ...
        {
            if (roleAssignmentDto == null || roleAssignmentDto.User_ID <= 0 || roleAssignmentDto.Role_ID <= 0)
            {
            ...
            try
            {
                var isAssigned = await _generalService.AssignRoleToUser(roleAssignmentDto.User_ID, roleAssignmentDto.Role_ID);
