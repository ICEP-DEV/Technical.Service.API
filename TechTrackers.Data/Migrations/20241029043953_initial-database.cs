    ...
    public partial class initialdatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Log_statush_istor", x => x.LogStatusHistoryId);
                    table.ForeignKey(
                        name: "FK_Log_statush_istor_Logs_LogId",
                        column: x => x.LogId,
                        principalTable: "Logs",
                        principalColumn: "LogId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Log_statush_istor_Users_ChangedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Log_statush_istor_ChangedByUserId",
                table: "Log_statush_istor",
                column: "ChangedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Log_statush_istor_LogId",
                table: "Log_statush_istor",
                column: "LogId");
